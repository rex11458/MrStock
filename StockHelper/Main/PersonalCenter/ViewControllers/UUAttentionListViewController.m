//
//  UUAttentionListViewController.m
//  StockHelper
//
...
@interface UUAttentionListViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation UUAttentionListViewController
...
- (void)loadData
{
    ...
    [[UUMeHandler sharedMeHandler] getFocusListWithType:0 pageIndex:_pageIndex pageCount:_pageCount success:^(NSArray *models) {
