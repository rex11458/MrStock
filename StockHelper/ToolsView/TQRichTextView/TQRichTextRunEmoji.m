...
- (void)drawRunWithRect:(CGRect)rect
{
    ...
    NSMutableString *emojiString = [NSMutableString stringWithFormat:@"%@.png",self.text];
    
    NSRange range = [emojiString rangeOfString:markL];
    if (range.location != NSNotFound) {
        [emojiString deleteCharactersInRange:range];
    }
     range = [emojiString rangeOfString:markR];
    if (range.location != NSNotFound) {
        [emojiString deleteCharactersInRange:range];
    }
